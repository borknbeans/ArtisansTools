...
public enum ArtisanMaterials implements IArtisanMaterial{
    ...
    ArtisanMaterials(TagKey<Block> inverseTag, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
